...
const multer = require('multer') // it is node.js middleware for handling multipart/form-data, primarily used to upload files
...
const requiresAdmin = function () {  // check logged in user have admin rights or not.
  return [
